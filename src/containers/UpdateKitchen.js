...
class StyledForm extends Component {
    ...
    submit = (submittedValues) => {
        ...
        let id = this.state.defaultValues.id;
    ...
    componentDidMount = () => {
        ...
        let url = `/api/kitchens/${this.props.match.params.id}/?access_token=${access_token}`;
        let query = {
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
        ...
        fetch(url, query)
            ...
            .then(data => {
                ...
                this.formApi.setAllValues(data);
            })
            .catch(err => {
                this.setState({
                    overlay: "overlay on",
                ...
                <div>
                    <Form
                        ...
                        {formApi => {
                            ...
                            return (
                                <form onSubmit={this.formApi.submitForm} id="form2" className="form-container">
                            ...
                            <StyledSelect field="hoursTo" id="hoursTo" options={hourOptions} />
                                    ...
                                    <div className="input-div" >
                                        <button id="submit" type="submit" className="mb-4 btn btn-orange">Update Kitchen</button>
                                    </div>
