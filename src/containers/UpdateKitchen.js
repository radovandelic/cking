...
class StyledForm extends Component {
    ...
    submit = (submittedValues) => {
        ...
        let url = `https://cookwork.be/api/kitchens/${kitchen.id}/`;
        let query = {
            headers: {
        ...
        fetch(url, query)
            .then(res => res.json())
            .then(data => {
                if (window.localStorage.getItem("mykitchen")) {
    ...
    render = () => {
        ...
        kitchen = this.shapeDefaultValues(kitchen);
        return (
            this.state.redirect
                    ...
                    <Form
                        ...
                        {formApi => (
                            ...
                            <StyledSelect field="hoursTo" id="hoursTo" options={hourOptions} />
                                ...
                                <div className="input-div" >
                                    <button id="submit" type="submit" className="btn btn-orange">Update Kitchen</button>
                                </div>
