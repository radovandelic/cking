...
import { register, registerKitchen, weekDays, region, equipment, staff, type, cancellation, popup, errors } from "../data/text";
...
class StyledForm extends Component {
    ...
    formatDefaultValues = (kitchen) => {
        kitchen.phone = kitchen.phone || this.props.phone;
        if (!kitchen.id) {
